    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminRestaurants", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdminRestaurants_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Calification = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationHour = table.Column<DateTime>(nullable: false),
                    RestaurantId = table.Column<int>(nullable: true),
                    CustomerId = table.Column<int>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuReservations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuReservations_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MenuReservations_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateHour = table.Column<DateTime>(nullable: false),
                    ReservationId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReservationStates_States_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_AdminRestaurantId",
                table: "Restaurants",
                column: "AdminRestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuReservations_MenuId",
                table: "MenuReservations",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuReservations_ReservationId",
                table: "MenuReservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationStates_StateId",
                table: "ReservationStates",
                column: "StateId");

            migrationBuilder.AddForeignKey(
                name: "FK_Restaurants_AdminRestaurants_AdminRestaurantId",
                table: "Restaurants",
                column: "AdminRestaurantId",
                principalTable: "AdminRestaurants",
                principalColumn: "Id",
                onDelete: ReferentialAction.Restrict);
